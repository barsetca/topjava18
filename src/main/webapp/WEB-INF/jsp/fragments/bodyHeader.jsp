        ...
        <sec:authorize access="isAuthenticated()">
            <form:form class="form-inline my-2" action="logout" method="post">
                ...
                <div class="btn-group">
                    ...
                    <button type="button" class="btn btn-info ml-1 dropdown-toggle" data-toggle="dropdown"
        ...
        <sec:authorize access="isAnonymous()">
            <form:form class="form-inline my-2" id="login_form" action="spring_security_check" method="post">
                ...
                <div class="btn-group">
                    ...
                    <div class="dropdown-menu">
                        <a class="dropdown-item" href="${pageContext.request.contextPath}/login?language=en">English</a>
                        <a class="dropdown-item" href="${pageContext.request.contextPath}/login?language=ru">Russian</a>
                    </div>
                </div>
            </form:form>
        </sec:authorize>
